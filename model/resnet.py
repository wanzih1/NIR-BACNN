...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=6, norm_layer=None):
        ...
        self.conv1 = nn.Conv1d(in_channels=1, out_channels=self.in_channels, kernel_size=7, stride=2, padding=3,
                               bias=False)
...
#     model = resnet152(num_classes=11)
#     out = model(inputs)
#     print(out.shape)
